...
import com.lk.demo.converter.OrderMaster2OrderDTOConverter;
...
import com.lk.demo.repository.OrderDetailRepository;
import com.lk.demo.repository.OrderMasterRepository;
import com.lk.demo.service.OrderService;
import com.lk.demo.service.ProductService;
import com.lk.demo.utils.KeyUtil;
...
//        List<CartDTO> cartDTOList = new ArrayList<>();
        ...
        for (OrderDetail orderDetail : orderDTO.getOrderDetailList()){
            ...
            BeanUtils.copyProperties(productInfo, orderDetail);       //进行属性拷贝 将productInfo拷贝到orderDetail
